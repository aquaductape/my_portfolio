...
// export const iconEmail = icon({ prefix: "fas", iconName: "envelope" }).html[0];
// export const iconPhone = icon({ prefix: "fas", iconName: "phone-alt" }).html[0];
export const iconEmailJSX = () => (
  <svg
    aria-hidden="true"
    // @ts-ignore
    focusable="false"
